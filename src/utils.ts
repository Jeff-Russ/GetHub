...
namespace QueryStringUtils {
   ...
   */
   export function parseMixed(query_string:string, result: Record<string, any>={} ) { // used in index.html
  ...
  export function push(query_string:string) {  // used in index.html
